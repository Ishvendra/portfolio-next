...
const AboutPage = () => {
  return (
    <>
      <Head>
        <title>About | Ishvendra</title>
        <link rel='canonical' href='https://ishvendra.in/about' />
        <meta
          name='description'
          content='About Ishvendra - Fullstack Developer portfolio'
        />
        <meta property='og:title' content='About | Ishvendra' />
        <meta
          property='og:description'
          content='Learn more about Ishvendra, a fullstack developer.'
        />
        <meta property='og:type' content='website' />
        <meta property='og:url' content='https://ishvendra.in/about' />
        <meta
          property='og:image'
            ...
            <div className={styles['section-content']}>
              <div className={styles['edu-item']}>
                ...
                <div className={styles['edu-achievements']}>
                  ...
                  <span className={styles.dot}>•</span> Design Head at The
                  Listening Space
                </div>
              </div>
              <div className={styles['edu-item']}>
