        ...
        <main className='color'>
          <section>
            <p>
              ...
              <strong className='reveal'>Winding Wires and Conductors</strong>,
              operating in the{' '}
    ...
    sections: (
      <>
        <section id='my-role'>
          <h2>My Role</h2>
          <p>
            I worked as a <strong className='reveal'>Frontend Developer</strong>{' '}
            on this project and contributed to UI planning and integration.{' '}
            <strong className='reveal'>
        ...
        <section id='problem'>
          ...
          <p>
            ...
            <span className='reveal'>manual workflows</span> and{' '}
          ...
          <ul className='list'>
            <li className='list-item'>
              <Bullet />
              High risk of <strong className='reveal'>manual errors</strong> and
              data loss
            </li>
            <li className='list-item'>
              <Bullet />
              <span className='reveal'>Slow decision-making</span> and scattered
              records
            </li>
            <li className='list-item'>
              <Bullet />
              <strong className='reveal'>Limited traceability</strong> and poor
              audit readiness
            </li>
            <li className='list-item'>
              <Bullet />
              Difficulty in maintaining{' '}
              <span className='reveal'>compliance</span> across multiple
              stakeholders
            </li>
          </ul>
        </section>
      ...
      <>
        ...
        <section id='problem'>
          ...
          <ul className='list'>
            ...
            <li className='list-item'>
              <Bullet />
              <span className='reveal'>Delayed communication</span> of diet
              plans and updates
            </li>
            <li className='list-item'>
              <Bullet />
        ...
        <main className='color'>
          <section>
            <p>
              ...
              <span className='reveal'>multi-tenant architecture,</span> it
              allows each agency to manage its own data in isolation, supporting
              custom workflows, rich analytics and{' '}
      ...
      <>
        ...
        <section id='problem'>
          ...
          <ul className='list'>
            ...
            <li className='list-item'>
              <Bullet />
              <span className='reveal'>Enquiry Module: </span>Complex forms with
              React Hook Form, Yup validation, dynamic fields.
            </li>
            <li className='list-item'>
              <Bullet />
    ...
    overview: (
      <>
        <main className='color'>
          <section>
            <p>
              <span className='reveal'>Shashvat Mobile App</span> is a school
              communication and management platform built for parents, students,
              and staff to interact through features like chat, notifications,
              and profile management. Designed as a{' '}
              <span className='reveal'>lightweight mobile solution</span> using
              React Native, it prioritizes smooth user experience and
    ...
    overview: (
      <>
        <main className='color'>
          <section>
            <p>
              <span className='reveal'>Nuskin Website Revamp</span> was a
