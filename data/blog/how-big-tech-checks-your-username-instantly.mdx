...
Crucially, it **never gives a false negative**. It will never tell you a username is available when it is, in fact, taken. It can, however, sometimes give a **false positive**—telling you a username _might_ be taken when it's actually available. This is the key tradeoff for its incredible speed.
